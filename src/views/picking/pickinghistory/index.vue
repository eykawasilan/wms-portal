  ...
  <b-card>
    <b-row class="match-height">
      <b-col lg="12" md="12" sm="12" class="mt-3 mb-5">
        <h2>Pick List History</h2>
      </b-col>
    </b-row>
    <b-row class="match-height">
      <b-col md="4" sm="8" class="my-1 mr-auto">
        <b-form-group
          label="Sort"
          label-cols-sm="2"
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "total", label: "Total Items", sortable: true },
  ...
  methods: {
    ...
    async getList({ page, pageSize }) {
      try {
        ...
        const res = await this.$api.order.picking.getList({
          page,
          pageSize,
        });
